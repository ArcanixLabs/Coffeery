...
object LearnContent {
    ...
    val cards: List<LearnCard> = listOf(
        ...
        LearnCard(R.string.learn_l120_title, R.string.learn_l120_body, R.string.learn_ch_extraction),
        LearnCard(R.string.learn_l123_title, R.string.learn_l123_body, R.string.learn_ch_extraction),
        // methods
        ...
        LearnCard(R.string.learn_l113_title, R.string.learn_l113_body, R.string.learn_ch_tasting),
        ...
        LearnCard(R.string.learn_l111_title, R.string.learn_l111_body, R.string.learn_ch_equipment),
        // water_deep
