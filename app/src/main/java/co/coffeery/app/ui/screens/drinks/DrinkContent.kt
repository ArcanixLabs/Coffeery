...
object DrinkContent {
    ...
    val drinks: List<DrinkItem> = listOf(
        ...
        DrinkItem("cafezinho", R.string.drink_cafezinho_name, R.string.drink_cafezinho_summary, R.string.drink_cafezinho_body, DrinkGroup.REGIONAL),
        DrinkItem("sumiyaki", R.string.drink_sumi_yaki_name, R.string.drink_sumi_yaki_summary, R.string.drink_sumi_yaki_body, DrinkGroup.REGIONAL),
        DrinkItem("dibek", R.string.drink_dibek_name, R.string.drink_dibek_summary, R.string.drink_dibek_body, DrinkGroup.REGIONAL),
        DrinkItem("kopi_o", R.string.drink_kopi_o_name, R.string.drink_kopi_o_summary, R.string.drink_kopi_o_body, DrinkGroup.REGIONAL),
        DrinkItem("kopi_susu", R.string.drink_kopi_susu_name, R.string.drink_kopi_susu_summary, R.string.drink_kopi_susu_body, DrinkGroup.REGIONAL),
